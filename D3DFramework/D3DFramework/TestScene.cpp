...
void TestScene::OnLoaded()
{
	...
	// ºÎ½¬
	obj = ObjectManager::GetInstance()->CreateObject<Bush>();
	...
	// ·¹µå
	obj = ObjectManager::GetInstance()->CreateObject<RedMonster>();
	obj->transform->position = { -6.10,67.71,24.87 };
	obj = ObjectManager::GetInstance()->CreateObject<RedMonster>();
	obj->transform->position = { -1.88,67.71,-17.87 };
	// ºí·ç
	obj = ObjectManager::GetInstance()->CreateObject<BlueMonster>();
	...
	obj = ObjectManager::GetInstance()->CreateObject<MurkwolfMini>();
	...
	// µÎ²¨ºñ
	obj = ObjectManager::GetInstance()->CreateObject<Gromp>();
	obj->transform->position = { 29.28,67.73,-2.82 };
	obj = ObjectManager::GetInstance()->CreateObject<Gromp>();
	obj->transform->position = { -36.59,67.71,10.14 };

	// ¤‹¤‹ÀÌ À§
	obj = ObjectManager::GetInstance()->CreateObject<Razorbeak>();
	obj->transform->position = { -0.75,67.71,16.17 };
	obj = ObjectManager::GetInstance()->CreateObject<RazorbeakMini>();
	...
	// ÀÛ°ñ
	obj = ObjectManager::GetInstance()->CreateObject<Krug>();
	...
	// ¹ÙÀ§°Ô
	obj = ObjectManager::GetInstance()->CreateObject<Scuttleracer>();
	...
	//obj->AddComponent<PlayerController>(L"PlayerController");
	obj = ObjectManager::GetInstance()->CreateObject<Leona>();
	obj->transform->position = { 30,68,27 };
	//obj->AddComponent<PlayerController>(L"PlayerController");
	obj = ObjectManager::GetInstance()->CreateObject<Ahri>();
	...
	// ¹Ì´Ï¾ð
	obj = ObjectManager::GetInstance()->CreateObject<OrderMinionCaster>();
	obj->transform->position = { 26,68,38 };
	obj = ObjectManager::GetInstance()->CreateObject<OrderMinionMelee>();
	obj->transform->position = { 23,68,38 };
	obj = ObjectManager::GetInstance()->CreateObject<OrderMinionSiege>();
	obj->transform->position = { 20,68,38 };
	obj = ObjectManager::GetInstance()->CreateObject<OrderMinionSuper>();
	obj->transform->position = { 17,68,38 };

	obj = ObjectManager::GetInstance()->CreateObject<ChaosMinionCaster>();
	obj->transform->position = { 26,68,39 };
	obj = ObjectManager::GetInstance()->CreateObject<ChaosMinionMelee>();
	obj->transform->position = { 23,68,39 };
	obj = ObjectManager::GetInstance()->CreateObject<ChaosMinionSiege>();
	obj->transform->position = { 20,68,39 };
	obj = ObjectManager::GetInstance()->CreateObject<ChaosMinionSuper>();
