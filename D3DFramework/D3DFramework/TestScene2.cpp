...
void TestScene2::OnLoaded()
{
	...
	// 플레이어
	Unit* unit = (Unit*)SceneManager::GetCurrentScene()->CreateObject<Missfortune>(Layer::Unit);
...
void TestScene2::CreateEnvironment()
{
...
void TestScene2::CreateBuilding()
{
	Unit* unit = nullptr;
...
void TestScene2::CreateMinionCaster()
{
...
void TestScene2::CreateMinionMelee()
{
	Minion* minion = nullptr;
	// 블루========================================================
...
void TestScene2::CreateMinionSiege()
{
	Minion* minion = nullptr;
	// 블루
...
void TestScene2::CreateMinionSuper()
{
	Minion* minion = nullptr;
	// 블루
